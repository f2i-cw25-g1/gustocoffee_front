    ...
    <>
      <main>
        <div className="container">
          ...
          <p className="section_title2">Définitions</p>
          ...
          <p className="section_title2">Nature des données collectées</p>
          <b>Dans le cadre de l'utilisation des Sites, l'Éditeur est susceptible de collecter les catégories de données suivantes concernant ses Utilisateurs :</b>
          ...
          <p className="section_title2">Communication des données personnelles à des tiers</p>
          ...
          <p className="section_title2">Information préalable pour la communication des données personnelles à des tiers en cas de fusion / absorption</p>
          <b>Collecte de l’opt-in (consentement) préalable à la transmission des données suite à une fusion / acquisition</b>
          ...
          <p className="section_title2">Agrégation des données</p>
          ...
          <b>Agrégation avec des données personnelles disponibles sur les comptes sociaux de l'Utilisateur</b>
          ...
          <p className="section_title2">Collecte des données d'identité</p>
          <b>Inscription et identification préalable pour la fourniture du service</b>
          ...
          <p className="section_title2">Collecte des données d'identification</p>
          <b>Utilisation de l'identifiant de l’utilisateur uniquement pour l’accès aux services</b>
          <p>Nous utilisons vos identifiants électroniques seulement pour et pendant l'exécution du contrat.</p>

          <p className="section_title2">Collecte des données du terminal</p>
          <b>Aucune collecte des données techniques</b>
          ...
          <p className="section_title2">Cookies</p>
          ...
          <p>Nous n'utilisons pas de cookies. Si nous devions en utiliser à l’avenir, vous en seriez informé préalablement et auriez la possibilité de désactiver ces cookies.</p>

          <p className="section_title2">Conservation des données techniques</p>
          ...
          <p className="section_title2">Délai de conservation des données personnelles et d'anonymisation</p>
          ...
          <p>Pour des raisons de sécurité, si vous ne vous êtes pas authentifié sur le Site pendant une période de trois ans, vous recevrez un email vous invitant à vous connecter dans les plus brefs délais, sans quoi vos données seront supprimées de nos bases de données.</p>

          <p className="section_title2">Suppression du compte</p>
          ...
          <b>Suppression du compte en cas de violation des CGU</b>
          ...
          <p className="section_title2">Indications en cas de faille de sécurité décelée par l'Éditeur</p>
          ...
          <p className="section_title2">Modification des CGU et de la politique de confidentialité</p>
          <b>En cas de modification des présentes CGU, engagement de ne pas baisser le niveau de confidentialité de manière substantielle sans l'information préalable des personnes concernées</b>
          ...
          <p className="section_title2">Droit applicable et modalités de recours</p>
          ...
          <p className="section_title2">Portabilité des données</p>
